...
func Parse(r *http.Request, v interface{}) error {
	...
	if err := ParseXmlBody(r, v); err != nil {
		return err
	}
...
// ParseXmlBody parses the post request which contains xml in body.
func ParseXmlBody(r *http.Request, v interface{}) error {
	if body, err := ioutil.ReadAll(r.Body); err != nil {
		return err
	} else if err = xml.Unmarshal(body, v); err != nil {
		return err
	}
	return nil
}
...
func withXmlBody(r *http.Request) bool {
