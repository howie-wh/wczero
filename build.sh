...
run_server() {
  ...
  .bin/user-api -f services/user/api/etc/user-api.yaml
  .bin/wallpaper-rpc -f services/wallpaper/rpc/etc/wallpaper.yaml
  .bin/wallpaper-api -f services/wallpaper/api/etc/wallpaper-api.yaml
